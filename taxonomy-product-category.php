        ...
        <main id="main" class="clearfix" role="main">
            <?php if (have_posts()) : ?>
                ...
                <table class="prod-tbl" cellspacing="0">
                    ...
                    <tr>
                        <th>#</th>
                        <th><i class="fa fa-asterisk"></i> Product Name</th>
                        <th><i class="fa fa-list-alt"></i> Composition</th>
                        <th><i class="fa fa-medkit"></i> Packaging</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    while (have_posts()) : the_post();
                        ...
                        <tr>
                            ...
                            <td><a href="<?php the_permalink(); ?>"
                                   title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a><i
