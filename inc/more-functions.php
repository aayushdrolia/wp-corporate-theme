...
function corpo_load_user_styles()
{
    ...
    wp_enqueue_style('font-awesome', get_template_directory_uri() . '/assets/font-awesome/css/font-awesome.min.css', array(), null);
...
function corpo_load_user_scripts()
{
    ...
    // Enqueue our own jquery
    wp_deregister_script('jquery');
    wp_register_script('jquery', get_template_directory_uri() . '/assets/jquery/dist/jquery.min.js', array(), null, 1);
    wp_enqueue_script('jquery');

    // Enqueue Slider  js file
    if (is_front_page()) {
        wp_enqueue_script('jquery-cycle', get_template_directory_uri() . '/assets/cycle/jquery.cycle.lite.js', array('jquery'), null, true);
    }
    wp_enqueue_script('corpo-theme-custom', get_template_directory_uri() . '/js/public.js', array('jquery'), null, true);


}

add_action('wp_enqueue_scripts', 'corpo_load_user_scripts', 1);
    ...
    <footer class="entry-footer clearfix">
        ...
        if (!is_single() && !post_password_required() && (comments_open() || get_comments_number())) {
            ...
            <span class="comments-link"><i
                    class="fa fa-comment"></i><?php comments_popup_link('No Comments', '1 Comment', '% Comments', '', 'Comments Off'); ?></span> <?php
        }
        edit_post_link(__('Edit'), '<span class="edit-link"><i class="fa fa-edit"></i>', '</span>'); ?>
        <?php
        if (!is_single()) {
            ?><span class="read-more-link"><a class="read-more" href="<?php the_permalink(); ?>">Read more&ensp;<i
                    class="fa fa-arrow-right"></i></a></span><?php
        }
        ?>
    </footer>
    <?php
