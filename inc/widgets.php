...
class ank_featured_single_page_widget extends WP_Widget
{
    function __construct()
    {
        ...
        parent::__construct('ank_featured_single_page_widget', $name = 'AK: Featured Single Page', $widget_ops, $control_ops);
    }
...
class ank_call_to_action_widget extends WP_Widget
{
    function __construct()
    {
        ...
        $control_ops = array('width' => 200, 'height' => 250);
        parent::__construct('ank_call_to_action_widget', $name = 'AK: Call To Action Widget', $widget_ops, $control_ops);
    }
...
class ank_our_service_widget extends WP_Widget
{
    function __construct()
    {
        ...
        $control_ops = array('width' => 200, 'height' => 250);
        parent::__construct('ank_image_service_widget', $name = 'AK: Our Services', $widget_ops, $control_ops);
    }
...
class ank_custom_tag_widget extends WP_Widget
{
    function __construct()
    {
        ...
        $control_ops = array('width' => 200, 'height' => 250);
        parent::__construct('ank_custom_tag_widget', $name = 'AK: Custom Tag Cloud', $widget_ops, $control_ops);
    }
...
class ank_promo_box_widget extends WP_Widget
{
    ...
    function __construct()
    {
        ...
        $control_ops = array('width' => 200, 'height' => 250);
        parent::__construct('ank_promo_box_widget', $name = 'AK: Promo Box', $widget_ops, $control_ops);
    }
...
class ank_slogan_box_widget extends WP_Widget
{
    ...
    function __construct()
    {
        ...
        $control_ops = array('width' => 200, 'height' => 250);
        parent::__construct('ank_slogan_box_widget', $name = 'AK: Slogan Box', $widget_ops, $control_ops);
    }
...
class ank_recent_work_widget extends WP_Widget
{
    function __construct()
    {
        ...
        $control_ops = array('width' => 200, 'height' => 250);
        parent::__construct('ank_recent_work_widget', $name = 'AK: Featured Recent Work', $widget_ops, $control_ops);
    }
...
class ank_our_clients_widget extends WP_Widget
{
    ...
    function __construct()
    {
        ...
        $control_ops = array('width' => 200, 'height' => 250);
        parent::__construct(false, $name = 'AK: Our Clients', $widget_ops, $control_ops);
    }
